...
import application.tests.BaseClass;

public class HomePage extends BaseClass{

	
	@FindBy(xpath="//*[text()=\" Signup / Login\"]")WebElement signUpButton;
	@FindBy(xpath="//*[text()=\" Contact us\"]")WebElement contactUsButton;
	@FindBy(xpath="//*[text()=\" Test Cases\"]")WebElement testcaseButton;
	@FindBy(xpath="//*[text()=\" Products\"]")WebElement productsButton;
	@FindBy(xpath="//*[text()=\" Cart\"]")WebElement cartButton;
	@FindBy(xpath="//*[text()=\" Delete Account\"]")WebElement delete_account;
	@FindBy(xpath="//*[text()=\"Account Deleted!\"]")public WebElement delete_Message;
	@FindBy(xpath="//*[text()=\" Logged in as \"]")public WebElement logged_in_as;
	@FindBy(xpath="//*[@href=\"/logout\"]")WebElement logout;
	@FindBy(xpath="//*[text()=\"Test Cases\"]")public WebElement testCasetag;
	@FindBy(xpath="//*[text()=\"Subscription\"]")public WebElement subscriptionTag;
	@FindBy(xpath="//*[@id=\"susbscribe_email\"]")WebElement subscriptionID;
	@FindBy(xpath="//*[@id=\"subscribe\"]/i")WebElement subscribeButton;
	@FindBy(xpath="//*[text()=\"You have been successfully subscribed!\"]")public WebElement subscribed_msg;
	@FindBy(xpath="/html/body/section[2]/div/div/div[2]/div[1]/div[2]/div/div[1]/div[1]")public WebElement product_One;
	@FindBy(xpath="/html/body/section[2]/div/div/div[2]/div[1]/div[3]/div/div[1]/div[1]")public WebElement product_Two;
	@FindBy(xpath="/html/body/section[2]/div/div/div[2]/div[1]/div[2]/div/div[1]/div[1]/a")WebElement product_one_to_cart;
	@FindBy(xpath="/html/body/section[2]/div/div/div[2]/div[1]/div[3]/div/div[1]/div[1]/a")WebElement product_two_to_cart;
	@FindBy(xpath="/html/body/section[2]/div[1]/div/div[2]/div[1]/div[2]/div/div[1]/div[1]/a")WebElement add_to_cart_One;
	@FindBy(xpath="/html/body/section[2]/div[1]/div/div[2]/div[1]/div[3]/div/div[1]/div[1]/a")	WebElement add_to_cart_Two;
	@FindBy(xpath="//*[text()=\"recommended items\"]")WebElement rec_items;
	@FindBy(xpath="//*[@id=\"recommended-item-carousel\"]/div/div[1]/div[1]/div/div/div/a")WebElement rec_product_to_cart;
	@FindBy(xpath="//*[@id=\"scrollUp\"]/i")WebElement scrollUp;
	@FindBy(xpath="//*[text()=\"Full-Fledged practice website for Automation Engineers\"]")WebElement text;
	@FindBy(xpath="//*[@src=\"/static/images/home/logo.png\"]")WebElement logo;
